    ...
    public class InvokeAnonymiseBackup : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            do
            {
                ...
                try
                {
                    resultSegment = sourceBlobContainer.ListBlobsSegmented(blobContinuationToken);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
            ...
            foreach (var file in filesToAnonymise)
            {
                ...
                //read data for blob
                var backupDataBlob = AzureStorageHelper.ReadBlobDataFromStorageContainer(sourceBlobContainer, filename);
